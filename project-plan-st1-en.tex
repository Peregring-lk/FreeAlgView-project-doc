...
clauses
(\parref{sssec:doc-importation-plan,ssec:investigation-plan,ssec:monitoring-plan}):
...
of the decisions made. As with the importation plan
(\parref{sssec:doc-importation-plan}), each investigation must be
